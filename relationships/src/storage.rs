...
mod test {
            ...
            "[
  {
    ...
    fn successfully_write_json() {
        ...
        assert_eq!(
            file_contents,
            "[{\"variant\":{\"Related\":\"Undirected\"},\"participant_1\":\"00000000-0000-0000-0000-000000000000\",\"participant_2\":\"00000000-0000-0000-0000-000000000000\",\"id\":\"00000000-0000-0000-0000-000000000000\"}]"
        )
    }
