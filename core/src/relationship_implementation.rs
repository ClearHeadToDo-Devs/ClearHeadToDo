...
impl RelationshipListManagement for ClearHeadApp {
    ...
    fn append_related_relationship(&self, participant_1: Uuid, participant_2: Uuid) -> ClearHeadApp {
        let mut cloned_app = self.clone();

        let updated_relationship_list = self.relationship_list.append_related_relationship(
            participant_1,
            participant_2,
        );
    ...
    fn append_sequential_relationship(&self, participant_1: Uuid, participant_2: Uuid) -> Self::L {
        ...
        let updated_relationship_list = self.relationship_list.append_sequential_relationship(
            participant_1,
            participant_2,
        );
    ...
    fn append_parental_relationship(&self, participant_1: Uuid, participant_2: Uuid) -> ClearHeadApp {
        let mut cloned_app = self.clone();

        let updated_relationship_list = self.relationship_list.append_parental_relationship(
            participant_1,
            participant_2,
        );
    ...
    fn get_relationship_participant_1(&self, index: usize) -> Result<Uuid, Box<dyn Error>> {
        Ok(self.relationship_list.get_relationship_participant_1(index)?)
    }

    fn get_relationship_participant_2(&self, index: usize) -> Result<Uuid, Box<dyn Error>> {
        Ok(self.relationship_list.get_relationship_participant_2(index)?)
    }
    ...
    fn change_relationship_variant(&self, index: usize, variant: &str) -> Result<Self::L, Box<dyn Error>> {
        ...
        let updated_relationship_list = self.relationship_list.change_relationship_variant(index, variant)?;
        cloned_app.relationship_list = updated_relationship_list;
        Ok(cloned_app)
    }
    ...
    fn update_relationship_participant_1(&self, index: usize, new_id: Uuid) -> Result<Self::L, Box<dyn Error>> {
        ...
        let updated_relationship_list = self.relationship_list.update_relationship_participant_1(index, new_id)?;
        cloned_app.relationship_list = updated_relationship_list;
        Ok(cloned_app)
    }
    ...
    fn update_relationship_participant_2(&self, index: usize, new_id: Uuid) -> Result<Self::L, Box<dyn Error>> {
        ...
        let updated_relationship_list = self.relationship_list.update_relationship_participant_2(index, new_id)?;
        cloned_app.relationship_list = updated_relationship_list;
        Ok(cloned_app)
    }
...
mod tests {
    ...
    pub fn create_app_with_single_relationship(variant_str: &str) -> ClearHeadApp {
        ClearHeadApp::default().append_new_relationship(variant_str, Uuid::nil(), Uuid::nil()).unwrap()
    }
    ...
    fn create_relationship() {
        ...
        let updated_app = test_app.append_new_relationship("related", Uuid::nil(), Uuid::nil()).unwrap();
    ...
    fn failed_create_relationship(){
        ...
        let bad_variant_error = test_app.append_new_relationship("invalid", Uuid::nil(), Uuid::nil()).unwrap_err();
    ...
    fn create_sequential(){
        ...
        let updated_app = test_app.append_new_relationship("sequential", Uuid::nil(), Uuid::nil()).unwrap();
    ...
    fn create_parental(){
        ...
        let updated_app = test_app.append_new_relationship("parental", Uuid::nil(), Uuid::nil()).unwrap();

        assert_eq!(updated_app.get_relationship_variant(0).unwrap(), RelationshipVariant::create_parental());
    }
    ...
    fn create_related_direct(){
        ...
        assert_eq!(updated_app.get_relationship_variant(0).unwrap(), RelationshipVariant::create_related());
    }
    ...
    fn get_id(){
        ...
        assert_eq!(id, test_app.relationship_list.get_relationship_id(0).unwrap());
    }
    ...
    fn select_by_index(){
        ...
        let selected = RelationshipListManagement::select_relationship_by_index(&test_app, 0).unwrap();
    ...
    fn failed_select_by_index(){
        ...
        let index_error = RelationshipListManagement::select_relationship_by_index(&empty_app, 0).unwrap_err();
    ...
    fn select_by_id(){
        ...
        let selected = RelationshipListManagement::select_relationship_by_id(&test_app, target_id).unwrap();
    ...
    fn failed_select_by_id(){
        ...
        let index_error = RelationshipListManagement::select_relationship_by_id(&empty_app, Uuid::nil()).unwrap_err();
    ...
    fn update_participant_1(){
        ...
        let updated_app = test_app.update_relationship_participant_1(0, test_id).unwrap();

        assert_eq!(updated_app.get_relationship_participant_1(0).unwrap(), test_id);
    }
    ...
    fn failed_update_participant_1(){
        ...
        let index_error = empty_app.update_relationship_participant_1(0, Uuid::nil()).unwrap_err();
    ...
    fn update_participant_2(){
        ...
        let updated_app = test_app.update_relationship_participant_2(0, test_id).unwrap();

        assert_eq!(updated_app.get_relationship_participant_2(0).unwrap(), test_id);
    }
    ...
    fn failed_change_variant_bad_index(){
        ...
        let index_error = empty_app.change_relationship_variant(0, "related").unwrap_err();
    ...
    fn failed_change_variant_bad_variant(){
        ...
        let index_error = test_app.change_relationship_variant(0, "bad_variant").unwrap_err();
    ...
    fn get_participant_1_list_for_id(){
        let test_app = ClearHeadApp::default().append_related_relationship(Uuid::nil(), Uuid::new_v4());

        let result = test_app.get_participant_1_list_for_id(Uuid::nil()).unwrap();

        assert_eq!(result.select_relationship_by_index(0).unwrap(), test_app.select_relationship_by_index(0).unwrap());
    }
    ...
    fn get_participant_2_list_for_id(){
        let test_app = ClearHeadApp::default().append_related_relationship(Uuid::new_v4(), Uuid::nil());
