...
fn failed_create_from_string() {
    ...
    let updated_list =
        relationship_list.append_new_relationship(&variant_string, Uuid::nil(), Uuid::nil());
...
fn successfully_get_participant_2() {
    ...
    let single_relationship_list =
        test_list.append_new_relationship("parental", Uuid::nil(), Uuid::nil()).unwrap();
...
fn successfully_remove_from_id() {
    let relationship_list: Vector<Relationship> = Vector::new();
    let single_relationship_list = relationship_list
...
fn change_related_to_parental() {
    let relationship_list: Vector<Relationship> = Vector::new();
    let test_list = relationship_list
        .append_new_relationship("related", Uuid::nil(), Uuid::nil())
        .unwrap();

    let updated_list = test_list
        .change_relationship_variant(0, "parental")
        .unwrap();
...
fn failed_change_variant() {
    ...
    let failed_output = test_list
        .change_relationship_variant(0, "bad variant")
        .unwrap_err();
...
fn update_participant_2_id() {
    let relationship_list: Vector<Relationship> = Vector::new();
    let test_list = relationship_list.append_new_relationship("related", Uuid::nil(), Uuid::nil()).unwrap();
...
fn false_check_id_against_either_participant_lists() {
    ...
    let query_result =
        empty_relationship_list.id_is_present_in_either_participant_list(Uuid::new_v4());
...
fn get_participant_1_list_for_id() {
    ...
    assert_eq!(
        query_result[0],
        single_relationship_list
            .select_relationship_by_index(0)
            .unwrap()
    );
}
...
fn failed_get_participant_1_list_for_id() {
    ...
    let query_result = empty_relationship_list
        .get_participant_1_list_for_id(Uuid::new_v4())
        .unwrap_err();
...
fn failed_get_participant_2_list_for_id() {
    ...
    let query_result = empty_relationship_list
        .get_participant_2_list_for_id(Uuid::new_v4())
        .unwrap_err();
...
fn get_either_participant_list_for_id_one_in_each() {
    ...
    let single_relationship_list =
        empty_list.append_new_relationship("related", Uuid::new_v4(), Uuid::nil()).unwrap();
...
fn failed_get_either_participant_list_for_id() {
    ...
    let query_result = empty_relationship_list
        .get_either_participant_list_for_id(Uuid::new_v4())
        .unwrap_err();
...
fn get_parental_relationship_list() {
    let single_relationship_list = create_relationship_list_with_single_relationship("parental");
    let double_relationship_list =
        single_relationship_list.append_new_relationship("related", Uuid::nil(), Uuid::nil()).unwrap();

    let query_result = double_relationship_list
        .filter_by_variant("parental")
        .unwrap();
...
fn get_related_relationship_list() {
    ...
    let double_relationship_list =
        single_relationship_list.append_new_relationship("parental", Uuid::nil(), Uuid::nil()).unwrap();

    let query_result = double_relationship_list
        .filter_by_variant("related")
        .unwrap();
...
fn filter_by_participant_1_list() {
    ...
    let query_result = double_relationship_list
        .filter_by_participants("p1".to_string(), Uuid::nil())
        .unwrap();
...
fn filter_by_participant_2_list() {
    ...
    let query_result = double_relationship_list
        .filter_by_participants("p2".to_string(), Uuid::nil())
        .unwrap();
...
fn filter_by_either_participant_list() {
    ...
    let query_result = double_relationship_list
        .filter_by_participants("3".to_string(), Uuid::nil())
        .unwrap();
...
fn failed_filter_by_participant_list_bad_list() {
    ...
    let query_result = double_relationship_list
        .filter_by_participants("bad".to_string(), Uuid::nil())
        .unwrap_err();
